...
Dracula also has to set his favorite text editor, following the `core.editor` 
command [table in the "Pro Git" book's appendix](https://git-scm.com/book/en/v2/Appendix-C%3A-Git-Commands-Setup-and-Config#_core_editor).
